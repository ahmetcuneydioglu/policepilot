...
export default function NotificationBell() {
  const { notifications, unreadCount, markAllRead, bellShaking } = useNotifications();
  ...
  return (
    <>
      ...
      <div ref={ref} className="relative">
        ...
        >
          <svg
            className={`w-5 h-5 ${bellShaking ? "bell-shake" : ""}`}
            fill="none"
            stroke="currentColor"
            viewBox="0 0 24 24"
          >
          ...
          {unreadCount > 0 && (
            <span className="absolute -top-0.5 -right-0.5 min-w-[18px] h-[18px] px-1 rounded-full bg-red-500 text-white text-[9px] font-extrabold flex items-center justify-center leading-none ring-2 ring-white animate-bounce">
